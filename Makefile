...
#YWDRIVER_MODI add
LIBS += common/encrypt/libencrypt.a
#YWDRIVER_MODI add
...
$(obj)u-boot.bin:	$(obj)u-boot
		...
		###YWDRIVER_MODI lwj add begin
		mv u-boot.bin u-boot.bak.bin
	    ./tools/make_ubootpad u-boot.bak.bin u-boot.bin $(U_BOOT_PADSIZE)
		####YWDRIVER_MODI lwj add end
...
ifeq ($(COMBO),yes)
	@echo "#define COMBO" >>include/config.h
endif
ifeq ($(NAND),yes)
...
#########################################################################
###############add for install d02sh#####################################
.PHONY: install
install:
	-@cp u-boot.bin ~/workspace/target
	-@cp u-boot.bin ~/workspace/box
