...
#define UPDATE_CFG_KERNEL_BASE      CFG_YW_KERNEL_BASE_HEX  //内核基址
#define UPDATE_CFG_KERNEL_SEC       CFG_YW_KERNEL_SEC

#define UPDATE_CFG_ROOTFS_BASE      CFG_YW_ROOTFS_BASE      //usr root基址
#define UPDATE_CFG_ROOTFS_SEC       CFG_YW_ROOTFS_SEC
