 ...
 *
 * $Source: D:/STB_BASE_HAL/u-boot-sh4-1.3.1_stm23_0043/include/configs/barco.h,v $
 * $Revision: 1.1.1.1 $
 * $Author: d22cj $
 * $Date: 2010/01/20 05:03:20 $
 *
 * Last ChangeLog Entry
 * $Log: barco.h,v $
 * Revision 1.1.1.1  2010/01/20 05:03:20  d22cj
 * 1、U-Boot首次导入
 * 2、修改启动参数
 * 3、修改进入菜单的方法：只能用ESC或者键盘进入
 *
 * Revision 1.1.1.1  2009/07/08 08:47:32  d02sh
