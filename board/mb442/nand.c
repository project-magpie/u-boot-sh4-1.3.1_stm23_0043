 ...
 */
static void mb442_hwcontrol(struct mtd_info *mtdinfo, int cmd)
{
...
static int mb442_nand_ready(struct mtd_info* mtd)
{   
    
    return !(STPIO_GET_PIN(3, 5) == 0);
}
...
{
    nand->IO_ADDR_R = (void  *) CFG_NAND_BASE;
	nand->IO_ADDR_W = (void  *) CFG_NAND_BASE;
	nand->hwcontrol = mb442_hwcontrol;
	nand->eccmode = NAND_ECC_SOFT;
	nand->chip_delay = 25;
    nand->dev_ready = mb442_nand_ready;
