...
/*YWDRIVER_MODI d48zm 2010/3/11 modify this file
*Description: for boot-from-nand
*some code copy from u-boot-sh4-1.3.1_stm23_0046\board\hdk7111\nand.c
*/
#include <asm/stm-nand.h>	//YWDRIVER_MODI add
 ...
 */
#ifndef CFG_NAND_FLEX_MODE	/* for "bit-banging" (c.f. STM "flex-mode")  */ //YWDRIVER_MODI add
static void mb618_hwcontrol(struct mtd_info *mtdinfo, int cmd)
{
	...
	case NAND_CTL_SETCLE:
		this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W | (1u << 17));	// YWDRIVER_MODI 17 => 18
		break;
	...
	case NAND_CTL_SETALE:
		this->IO_ADDR_W = (void *)((unsigned int)this->IO_ADDR_W | (1u << 18)); // YWDRIVER_MODI 18 => 19
		break;
...
#endif /* CFG_NAND_FLEX_MODE */ //YWDRIVER_MODI add
...
{
	//nand->hwcontrol = mb618_hwcontrol; //YWDRIVER_MODI
	nand->eccmode       = NAND_ECC_SOFT;
	//nand->chip_delay = 25;			//YWDRIVER_MODI
...
//YWDRIVER_MODI add begin
	...
	/***** YWDRIVER_MODI 2010-10-08 D26LF Del:
	    Description:不使用坏块表
	*/
	#if 0
	...
	#endif
	/***** YWDRIVER_MODI 2010-10-08 D26LF Del end ****/
