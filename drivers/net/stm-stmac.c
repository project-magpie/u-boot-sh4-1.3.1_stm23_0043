...
// YWDRIVER_MODI cc 2009/05/15 add for different phy chip begin
        if(id1 | id2)
        {
...
// YWDRIVER_MODI cc 2009/05/15 add for different phy chip end
...
static int stmac_phy_init (void)
{
	...
	if (eth_phy_addr < 0)
		return -1;
// YWDRIVER_MODI 2009/09/23 cc remove for various phy chip begin
#if 0
...
#endif
#endif
// YWDRIVER_MODI 2009/09/23 cc remove for various phy chip end
