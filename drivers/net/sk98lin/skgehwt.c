 ...
 *
 *	$Log: skgehwt.c,v $
 *	Revision 1.1.1.1  2010/01/20 05:03:32  d22cj
 *	1、U-Boot首次导入
 *	2、修改启动参数
 *	3、修改进入菜单的方法：只能用ESC或者键盘进入
 *	
 *	Revision 1.1.1.1  2009/07/08 08:47:43  d02sh
...
static const char SysKonnectFileId[] =
	"$Header: /STB_BASE_HAL/u-boot-sh4-1.3.1_stm23_0043/drivers/net/sk98lin/skgehwt.c,v 1.1.1.1 2010/01/20 05:03:32 d22cj Exp $" ;
