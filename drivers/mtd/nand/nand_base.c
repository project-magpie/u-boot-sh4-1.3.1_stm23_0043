 ...
 *
 * $Id: nand_base.c,v 1.3 2011/10/21 01:52:25 d26lf Exp $
 *
...
// YWDRIVER_MODI changed by cc 到这一部了不能认为是错，否则bbt失败后，NAND也不可写了  2010/09/14 begin
#if 0
	...
	return 0;
#endif
// YWDRIVER_MODI changed by cc 2010/09/14 end
