	...
	const size_t maxPacketSize)
{
	...
	unsigned short *pPtr = (unsigned short *)dtfPacket;
...
extern int serial_tstc (void)
{
	...
	volatile int* pPtr = (volatile int*)&buff[0];
	int buffLen = 1;
